...
| Git       | Commit Safely        | Avoid `git add .`                             | Helps me avoid committing files I don’t mean to.                    |
|           | Add Files            | `git add src/ package.json package-lock.json` | Keeps commits clean and intentional.                                |
|           | SSH Auth             | `git@github.com:...`                          | Uses my SSH key, not username/password.                             |
